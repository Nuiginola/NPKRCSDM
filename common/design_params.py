...
PHI_C = 0.70            # ตัวคูณลดกำลังอัด (compression strength reduction factor) สำหรับเสาปลอกเดี่ยว
                         # (Tied Column) — ยืนยันจากไฟล์อ้างอิง SDM Plus_Column_Tied Pu.xlsx (H12=0.70)
                         # ใช้ในโมดูล 4.1 เสาสี่เหลี่ยม
PHI_C_SPIRAL = 0.75      # ตัวคูณลดกำลังอัดสำหรับเสาปลอกเกลียว (Spiral Column) — สูงกว่า PHI_C (เสา
                         # ปลอกเดี่ยว) ตามหลักการ ACI 318 21.2.2 (φ หน้าตัดควบคุมด้วยแรงอัด แตกต่างกัน
                         # ระหว่างเสาปลอกเกลียว/ปลอกเดี่ยว) — ยืนยันจากไฟล์อ้างอิง
                         # SDM Plus_Column_Spiral Pu.xlsx (H12=0.75) เทียบกับไฟล์ Tied (H12=0.70)
                         # ใช้ในโมดูล 4.2 เสากลม
