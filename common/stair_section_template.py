...
def render_section_png(inp, result, font_size=12):
    ...
    nx, ny = -uy, ux                          # เวกเตอร์ตั้งฉาก (ชี้ออกด้านล่างขวา = ด้านใต้เหล็ก โล่งกว่า)
    off = 44                                  # ระยะ offset เส้น bracket ออกจากแนวเหล็ก (ให้พ้นป้ายเหล็ก)
