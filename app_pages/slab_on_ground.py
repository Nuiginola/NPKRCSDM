...
from common.ui_style import inject_card_css, input_card, metric_card_row, render_calc_sheet, centered_image
...
if "gs_result" in st.session_state:
    ...
    centered_image(diagram_png, caption="Ground Slab — Joint & Reinforcement Detail")
